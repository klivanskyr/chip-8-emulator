...
Window::Window(size_t w, size_t h, Pixel initialColor) : width(w), height(h), pixels(w * h), tile_width(12), tile_height(12),
...
void Window::setPixel(size_t x, size_t y, Pixel color) {
    if (x < width && y < height) {
...
std::optional<Pixel> Window::getPixel(size_t x, size_t y) {
...
void Window::draw_rectangle(size_t x1, size_t y1, size_t x2, size_t y2, Pixel color) {
...
void Window::import_map(const std::string map_encoding, size_t num_tiles_x, size_t num_tiles_y) {
